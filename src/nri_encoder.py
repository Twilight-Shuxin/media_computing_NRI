...
class MLPBlock(nn.Module):
    ...
    def batch_norm(self, inputs):
        # perform bactchnorm along the second dimension
    ...
    def forward(self, input_batch):
        # Reshape input. The third dimension is #dims * #timesteps
        input_batch = input_batch.view(input_batch.size(0), input_batch.size(1), -1)
